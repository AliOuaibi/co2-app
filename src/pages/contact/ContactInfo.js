  ...
  return (
    <ul className="address-sec">
      ...
      <li>
        ...
        <span className="text"><em>Contact</em> <a href="">Mobile: (+33)6 25 01 12 50</a> <a href="mailto:gestionco2formation@outlook.com">Email: gestionco2formation@outlook.com</a></span>
      </li>
      <li>
