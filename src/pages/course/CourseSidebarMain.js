...
const CourseListMain = () => {
    ...
    return (
        <div className="react-course-filter back__course__page_grid back__course__page_grid_left pb---40 pt---100">
                            ...
                            <div className="col-md-6">
                                <div className="all__icons">
                                    <div className="grid__icons">
                                        <div className="grid__icons_inner">
                                            <span></span>
                                            <span></span>
                                            <span></span>
                                            <span></span>
                                        ...
                                        <Link to="/course-list" className="list__icons">
